...
In conclusion, this work demonstrates that multimodal, sequence-based modeling provides a viable and effective approach to predicting romantic attraction from short segments of dyadic interaction \citep{kraack2023, lebois2018}. By integrating facial expressions, body movement, vocal prosody, and language into a unified temporal framework, the proposed method advances computational approaches to interpersonal affect and social judgment. The presented approach opens several directions for future research, including exploring attention-based architectures for interpretability, systematic ablation studies, and generalization to more diverse datasets \citep{zadeh2017tensorfusionnetworkmultimodal, zhao2023swr}.
\section{References}
